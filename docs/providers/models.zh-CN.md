...
1. 向提供商认证（通常通过 `openclaw onboard`）。
2. 设置默认模型：
...
- [Alibaba Model Studio（阿里云模型工作室）](/providers/alibaba)
...
- [Qianfan（百度千帆）](/providers/qianfan)
- [Qwen（通义千问）](/providers/qwen)
- [Runway](/providers/runway)
- [StepFun（阶跃星辰）](/providers/stepfun)
...
- `anthropic-vertex` — 当 Vertex 凭据可用时，隐式支持 Google Vertex 上的 Anthropic；无需单独引导认证
