...
read_when:
  - 你想将 Gmail Pub/Sub 事件接入 OpenClaw 时
  - 你想了解 webhook 助手命令时
title: "Webhooks"
---
...
- Webhook：[Webhooks](/automation/cron-jobs#webhooks)
...
运行 `gog watch serve` 加上 watch 自动续订循环。
...
有关端到端设置流程和操作详情，请参阅 [Gmail Pub/Sub 文档](/automation/cron-jobs#gmail-pubsub-integration)。
